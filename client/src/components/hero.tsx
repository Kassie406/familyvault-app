        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-[1.1] tracking-tight mb-6 text-center">
              ...
              <span className="block border-b-2 border-[#D4AF37] pb-2 inline-block">in One Vault</span>
            </h1>
            <p className="text-xl text-[#CCCCCC] mb-8 leading-relaxed text-center">
            ...
            <p className="text-sm text-[#CCCCCC] mb-8 text-center">
            ...
            <div className="flex items-center justify-center space-x-6">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm text-[#CCCCCC]">Trustpilot</span>
              </div>
              <div className="text-sm text-[#CCCCCC]">Featured in Fast Company</div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-gray-800 rounded-t-2xl p-2 shadow-2xl">
              ...
              <div className="bg-gray-900 rounded-lg overflow-hidden relative">
                ...
                <div className="bg-gray-700 px-4 py-2 flex items-center space-x-2">
                  ...
                  <div className="flex-1 bg-gray-600 rounded px-3 py-1 text-xs text-[#CCCCCC]">
                    familyvault.com
                  </div>
                </div>
                ...
                <div className="p-6 min-h-80 bg-gradient-to-br from-gray-900 to-gray-800">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-800 border-l-4 border-[#D4AF37] rounded p-4 shadow-lg">
                      <div className="flex items-center">
                        <div className="w-3 h-3 bg-[#D4AF37] rounded-full mr-3 animate-pulse"></div>
                        <span className="text-[#CCCCCC] text-sm">Important Documents</span>
                      </div>
                    </div>
                    <div className="bg-gray-800 border-l-4 border-[#D4AF37] rounded p-4 shadow-lg">
                      <div className="flex items-center">
                        <div className="w-3 h-3 bg-[#D4AF37] rounded-full mr-3 animate-pulse"></div>
                        <span className="text-[#CCCCCC] text-sm">Emergency Contacts</span>
                      </div>
                    </div>
                    <div className="bg-gray-800 border-l-4 border-[#D4AF37] rounded p-4 shadow-lg">
                      <div className="flex items-center">
                        <div className="w-3 h-3 bg-[#D4AF37] rounded-full mr-3 animate-pulse"></div>
                        <span className="text-[#CCCCCC] text-sm">Medical Information</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-4 right-4">
                    <div className="w-12 h-12 bg-[#D4AF37] rounded-full opacity-20 animate-ping"></div>
                    <div className="absolute top-3 left-3 w-6 h-6 bg-[#D4AF37] rounded-full"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Gold glow effect */}
            <div className="absolute inset-0 bg-[#D4AF37]/10 blur-xl rounded-2xl -z-10"></div>
          </div>
        </div>
      </div>
    </section>
