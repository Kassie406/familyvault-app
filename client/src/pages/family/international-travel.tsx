...
import { Plus, Search, ChevronRight, Plane, MapPin, FileText, Shield, Calendar, CreditCard } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0F0F0F] text-white">
      ...
      <div className="sticky top-0 z-20 -mx-6 border-b border-white/8 bg-black/60 backdrop-blur">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center gap-3">
          <h1 className="text-[28px] font-semibold tracking-tight text-white" data-testid="text-page-title">International Travel</h1>
