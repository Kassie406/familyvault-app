...
import { Search, Plus, Plane, MapPin, FileText, Shield, Calendar } from 'lucide-react';
  ...
  const travelCategories = [
    {
      ...
      description: 'Passports, visas, travel insurance, and identification documents',
      icon: FileText,
      count: 0
    },
    {
      ...
      description: 'Flight details, accommodation bookings, and travel schedules',
      icon: Calendar,
      count: 0
    },
    {
      ...
      description: 'Embassy contacts, emergency numbers, and medical information',
      icon: Shield,
      count: 0
    },
    {
      ...
      description: 'Local contacts, addresses, and important location details',
      icon: MapPin,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">International Travel</h1>
      ...
      <div className="mt-12 text-center">
        <Plane className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Organize Your International Travel</h3>
