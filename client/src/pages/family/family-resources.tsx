        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-56 bg-white border-2 border-gray-200 shadow-lg rounded-lg p-2">
              <DropdownMenuItem className="px-4 py-3 hover:bg-black hover:text-white rounded-md cursor-pointer text-gray-700 font-medium" data-testid="button-important-document">
                Important Document
              </DropdownMenuItem>
              <DropdownMenuItem className="px-4 py-3 hover:bg-black hover:text-white rounded-md cursor-pointer text-gray-700 font-medium" data-testid="button-emergency-equipment">
                Emergency Equipment
              </DropdownMenuItem>
              <DropdownMenuItem className="px-4 py-3 hover:bg-black hover:text-white rounded-md cursor-pointer text-gray-700 font-medium" data-testid="button-letter-loved-one">
                Letter to Loved One
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
