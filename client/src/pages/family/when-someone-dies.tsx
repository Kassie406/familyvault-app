...
import { Search, Plus, Leaf, FileText, Phone, DollarSign, Heart } from 'lucide-react';
...
export default function WhenSomeoneDies() {
  ...
  const bereavementCategories = [
    {
      id: 1,
      title: 'Immediate Tasks',
      description: 'Death certificates, funeral arrangements, and immediate notifications',
      icon: FileText,
      count: 0
    },
    {
      ...
      description: 'Estate settlement, accounts, insurance claims, and financial obligations',
      icon: DollarSign,
      count: 0
    },
    {
      ...
      description: 'Probate process, will execution, and legal documentation',
      icon: Leaf,
      count: 0
    },
    {
      ...
      description: 'Grief counseling, support groups, and memorial planning',
      icon: Heart,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">When Someone Dies</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {bereavementCategories.map((category) => {
      ...
      <div className="mt-12 text-center">
        <Leaf className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Navigate Difficult Times</h3>
