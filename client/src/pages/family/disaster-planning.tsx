...
import { Search, Plus, AlertTriangle, MapPin, Radio, Heart, Shield } from 'lucide-react';
  ...
  const emergencyCategories = [
    {
      ...
      description: 'Family, authorities, utilities, and emergency service numbers',
      icon: Radio,
      count: 0
    },
    {
      ...
      description: 'Routes, meeting points, and evacuation procedures',
      icon: MapPin,
      count: 0
    },
    {
      ...
      description: 'Food, water, medical supplies, and survival equipment inventory',
      icon: Shield,
      count: 0
    },
    {
      ...
      description: 'Medical conditions, medications, and healthcare provider details',
      icon: Heart,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">Disaster Planning</h1>
      ...
      <div className="mt-12 text-center">
        <AlertTriangle className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Prepare for Emergencies</h3>
