...
interface BereavementSectionPageProps {
  title: string;
  createTo?: string;
}

export default function BereavementSectionPage({ title, createTo }: BereavementSectionPageProps) {
        ...
        <div className="mx-auto max-w-6xl px-6 py-4">
          <div className="flex items-center gap-4">
            <Button 
              variant="ghost" 
              size="sm" 
              onClick={() => setLocation('/family/when-someone-dies')}
