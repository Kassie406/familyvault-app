...
interface ElderlySectionPageProps {
  title: string;
  createTo?: string;
}

export default function ElderlySectionPage({ title, createTo }: ElderlySectionPageProps) {
        ...
        <div className="mx-auto max-w-6xl px-6 py-4">
          <div className="flex items-center gap-4">
            <Button 
              variant="ghost" 
              size="sm" 
              onClick={() => setLocation('/family/elderly-parents')}
