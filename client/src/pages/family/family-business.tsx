...
const businessData = {
  ...
  contracts: [
    {
      id: '4',
      routeId: 'home-depot-contract',
      name: "Home Depot Subcontractor Contract",
      category: 'Contract',
      owner: 'Angel',
      itemCount: 8,
    ...
    {
      id: '6',
      routeId: 'client-service-agreement',
  ...
  licenses: [
    ...
    },
    {
      ...
      name: "Wells Fargo Business Insurance",
      category: 'Insurance',
      owner: 'Family',
      itemCount: 5,
  ...
  assets: [
    {
      id: '13',
      routeId: 'vehicles-vins',
      name: "Vehicles (VINs, titles)",
      category: 'Vehicle',
      owner: 'Angel',
      itemCount: 6,
    ...
    {
      id: '14',
      routeId: 'store-fixtures-racking',
      name: "Store Fixtures / Racking Tools",
      category: 'Equipment',
      owner: 'Family',
      itemCount: 18,
    ...
    {
      id: '15',
      routeId: 'laptops-software',
      name: "Laptops / Software Licenses",
      category: 'Technology',
      owner: 'Kassandra',
      itemCount: 11,
  ...
  financial: [
    ...
    {
      id: '17',
      routeId: 'business-bank-accounts',
      name: "Business Bank Accounts (linked to Finance)",
      category: 'Account',
      owner: 'Angel',
      itemCount: 5,
    ...
    },
    {
      id: '18',
      routeId: 'tax-filings',
      name: "Tax Filings (linked to Taxes)",
      category: 'Tax',
      owner: 'Family',
      itemCount: 9,
