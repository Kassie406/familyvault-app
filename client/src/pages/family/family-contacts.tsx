...
import { Plus, Search, ChevronRight, User, Users, Phone, Shield, Heart, Building2, MoreHorizontal, Check, X, HelpCircle, Bell } from "lucide-react";
...
export default function FamilyContacts() {
  ...
  const [tempTitle, setTempTitle] = useState('Contacts');
    ...
    <div className="min-h-screen bg-[var(--bg-900)]">
      ...
      <div className="text-white">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Metrics pill */}
          <div className="flex items-center gap-2 bg-[#D4AF37]/10 text-[#D4AF37] px-3 py-1.5 rounded-full" data-testid="text-contact-count">
