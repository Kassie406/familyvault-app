...
import { Search, Plus, Users as FamilyIcon, Heart, Baby, Shield, Calendar } from 'lucide-react';
  ...
  const familyCategories = [
    {
      ...
      description: 'Healthcare providers, fertility information, and planning resources',
      icon: Calendar,
      count: 0
    },
    {
      ...
      description: 'Medical records, birth plans, and pregnancy tracking information',
      icon: Baby,
      count: 0
    },
    {
      ...
      description: 'Budget planning, insurance, and family financial preparation',
      icon: Shield,
      count: 0
    },
    {
      ...
      description: 'Family support contacts, parenting resources, and community connections',
      icon: Heart,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">Starting a Family</h1>
      ...
      <div className="mt-12 text-center">
        <FamilyIcon className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Plan Your Growing Family</h3>
