...
import { Plus, Search, ChevronRight, Users as FamilyIcon, Heart, Baby, Shield, Calendar, FileText, MoreHorizontal, Check, X } from "lucide-react";
...
export default function StartingFamily() {
  ...
  const [pageTitle, setPageTitle] = useState('Starting a Family');
  const [tempTitle, setTempTitle] = useState('Starting a Family');
