...
import { Search, Plus, HeartHandshake, Calendar, CreditCard, Users, FileText } from 'lucide-react';
  ...
  const weddingCategories = [
    {
      ...
      description: 'Vendor contacts, venue details, timeline, and planning documents',
      icon: Calendar,
      count: 0
    },
    {
      ...
      description: 'Marriage license, name change documents, and legal paperwork',
      icon: FileText,
      count: 0
    },
    {
      ...
      description: 'Budget tracking, vendor payments, and financial documents',
      icon: CreditCard,
      count: 0
    },
    {
      ...
      description: 'Guest lists, RSVP tracking, and contact information',
      icon: Users,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">Getting Married</h1>
      ...
      <div className="mt-12 text-center">
        <HeartHandshake className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Plan Your Perfect Wedding</h3>
