...
import { Plus, Search, ChevronRight, UserPlus, FileText, Activity, Heart, Shield, Calendar, Users, MoreHorizontal, Check, X, HelpCircle, Bell } from "lucide-react";
...
export default function ChildInformation() {
  ...
  const [pageTitle, setPageTitle] = useState('Child Information');
  const [tempTitle, setTempTitle] = useState('Child Information');
