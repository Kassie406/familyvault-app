...
import { Search, Plus, Baby, Calendar, MapPin, User, FileText } from 'lucide-react';
  ...
  const childCategories = [
    {
      ...
      description: 'Official birth certificates and related documents',
      icon: FileText,
      count: 0
    },
    {
      ...
      description: 'Vaccination records, medical history, and health information',
      icon: User,
      count: 0
    },
    {
      ...
      description: 'Academic transcripts, report cards, and enrollment documents',
      icon: Calendar,
      count: 0
    },
    {
      ...
      description: 'Authorized pickup persons and emergency contact information',
      icon: MapPin,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">Child Information</h1>
      ...
      <div className="mt-12 text-center">
        <Baby className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Organize Your Child's Information</h3>
