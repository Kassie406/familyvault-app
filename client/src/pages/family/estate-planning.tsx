...
import { Plus, Search, ChevronRight, FileText, Shield, DollarSign, Users, Scale, Calculator, MoreHorizontal, Check, X, HelpCircle, Bell } from "lucide-react";
...
export default function EstatePlanning() {
  ...
  const [pageTitle, setPageTitle] = useState('Estate Planning');
  const [tempTitle, setTempTitle] = useState('Estate Planning');
