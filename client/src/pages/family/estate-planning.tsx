...
import { Search, Plus, FileText, Shield, DollarSign, Users, Scale } from 'lucide-react';
...
export default function EstatePlanning() {
  ...
  const estateCategories = [
    ...
    },
    {
      ...
      description: 'Accounts, investments, retirement funds, and asset documentation',
      icon: DollarSign,
      count: 0
    },
    {
      ...
      description: 'Designated beneficiaries and inheritance planning details',
      icon: Users,
      count: 0
    },
    {
      ...
      description: 'Insurance policies, property deeds, and important certificates',
      icon: Shield,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">Estate Planning</h1>
      ...
      <div className="mt-12 text-center">
        <FileText className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Plan Your Estate</h3>
