...
import { Search, Plus, Home as HouseIcon, DollarSign, FileText, Key, MapPin } from 'lucide-react';
...
export default function HomeBuying() {
  ...
  const homeBuyingCategories = [
    {
      id: 1,
      title: 'Financial Planning',
      description: 'Pre-approval letters, budget planning, and mortgage information',
      icon: DollarSign,
      count: 0
    },
    {
      ...
      description: 'Property listings, neighborhood information, and market analysis',
      icon: MapPin,
      count: 0
    },
    {
      ...
      description: 'Contracts, inspection reports, and closing documentation',
      icon: FileText,
      count: 0
    },
    {
      ...
      description: 'Real estate agents, lenders, inspectors, and service providers',
      icon: Key,
      count: 0
    }
  ];
    ...
    <div className="card p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          <h1 className="text-2xl font-bold text-[var(--ink-100)]">Home Buying</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {homeBuyingCategories.map((category) => {
      ...
      <div className="mt-12 text-center">
        <HouseIcon className="h-16 w-16 text-[var(--ink-400)] mx-auto mb-4" />
        <h3 className="text-xl font-semibold text-[var(--ink-100)] mb-2">Organize Your Home Purchase</h3>
