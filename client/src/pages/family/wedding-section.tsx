...
interface WeddingSectionPageProps {
  title: string;
  createTo?: string;
}

export default function WeddingSectionPage({ title, createTo }: WeddingSectionPageProps) {
        ...
        <div className="mx-auto max-w-6xl px-6 py-4">
          <div className="flex items-center gap-4">
            <Button 
              variant="ghost" 
              size="sm" 
              onClick={() => setLocation('/family/getting-married')}
